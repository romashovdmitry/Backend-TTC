    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(help_text="User's birth date", null=True, verbose_name="User's birth date")),
                ('photo', models.ImageField(help_text='User Photo', null=True, upload_to=user.models.user.define_user_photo_path, validators=[main.utils.image_file_extension_validator], verbose_name='User Photo')),
